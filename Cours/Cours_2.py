#------------------------------------------------------------------------------
# Cours MRP Prep'ISIMA 2.
# Contenu : Exceptions + itérateurs simples + fichiers.
# La version de python utilisée est la 3.7. Le codage est utf8.
# Lire les commentaires et le code exécutable.
# N'hésitez pas à me faire des retours sur ce support
# pour que je puisse l'améliorer, le compléter, le corriger, etc.
...
# Ceci n'est que la présentation de quelques éléments de base des exceptions.
# Il y a bien d'autres choses...

#------------------------------------------------------------------------------
# Quelques mots sur les itérateurs
#------------------------------------------------------------------------------
...
# Voici un exemple : 
it = (x**2 for x in range(6)) # Ceci est un itérateur, par un tuple.
...
#------------------------------------------------------------------------------
# Quelques mots sur les fichiers
#------------------------------------------------------------------------------
...
# évite d'avoir à faire explicitement l'opération d'ouverture du fichier.
# Outre cette économie de programmation, le fichier est fermé proprement,
# quoi qu'il se passe.
